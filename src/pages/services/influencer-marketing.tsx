...
const data = [
  {
    heading: "Instagram: Influencer Magic Can Help You Improve Your Instagram Game",
  ...
  {
    heading: "Facebook: AvancePR Can Help You Unlock the Potential of Influencer Marketing",
  ...
  {
    heading: "Youtube:Do you want to attract the attention of video-savvy audiences? ",
